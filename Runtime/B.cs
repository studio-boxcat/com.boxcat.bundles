...
namespace Bundles
{
    public static class B
    {
        ...
        public static IAssetOp<Texture2D> Texture(Address key) => Load<Texture2D>(key);
        public static IAssetOp<Texture2D> Texture(AssetLocation key) => Load<Texture2D>(key);
        public static Texture2D TextureSync(Address key) => LoadSync<Texture2D>(key);
        public static Texture2D TextureSync(AssetLocation key) => LoadSync<Texture2D>(key);
        ...
        public static IAssetOp<Material> Material(Address key) => Load<Material>(key);
        public static IAssetOp<Material> Material(AssetLocation key) => Load<Material>(key);
        public static Material MaterialSync(Address key) => LoadSync<Material>(key);
        public static Material MaterialSync(AssetLocation key) => LoadSync<Material>(key);
